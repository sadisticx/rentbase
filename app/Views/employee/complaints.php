...
<head>
    ...
    <title>Manage Complaints - RentBase</title>
...
<body>
    <div class="main-wrapper">
        ...
        <p class="page-subtitle">Review and manage tenant complaints</p>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="7" class="text-center" style="padding: 40px;">
                                    ...
                                    <p style="color: #64748b; margin-top: 16px;">No complaints found.</p>
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
    ...
    <script>
        ...
        function viewComplaint(id, tenant, room, subject, description, date) {
            ...
            document.getElementById('replyForm').action = '<?= base_url('employee/complaints/reply') ?>/' + id;
        ...
        function loadReplies(complaintId) {
            fetch('<?= base_url('employee/complaints/getReplies') ?>/' + complaintId)
        ...
        function updateStatus(id, currentStatus) {
            document.getElementById('updateStatusForm').action = '<?= base_url('employee/complaints/update') ?>/' + id;
