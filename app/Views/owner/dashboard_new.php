...
<head>
    ...
    <style>
        body {
            ...
            background: linear-gradient(135deg, #a8b7db 0%, #c4d5f0 50%, #d4dff5 100%);
            min-height: 100vh;
            padding: 20px;
        }
    ...
    <div class="main-wrapper">
        ...
        <div class="dashboard-grid">
            <div class="stat-card">
                ...
                <div class="stat-label">Add, edit, and manage your rooms</div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-value">-</div>
                <div class="stat-label">Add, edit, and manage your tenants</div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-value">-</div>
                <div class="stat-label">Manage parking slots allocation</div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-value">-</div>
                <div class="stat-label">Review tenant complaints</div>
            </div>
        </div>
