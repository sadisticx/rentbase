...
<body>
                        ...
                        <?php if (!empty($complaints)): ?>
                            <?php foreach ($complaints as $complaint): ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="action-btn btn-view" onclick="viewComplaint('<?= esc($complaint['tenant_username']) ?>', '<?= esc($complaint['room_number']) ?>', '<?= esc($complaint['subject']) ?>', '<?= esc($complaint['description']) ?>', '<?= date('M d, Y H:i', strtotime($complaint['created_at'])) ?>')">
    ...
    <script>
        function viewComplaint(tenant, room, subject, description, date) {
