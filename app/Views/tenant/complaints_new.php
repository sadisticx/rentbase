...
<body>
                                ...
                                <?php if (!empty($complaints)): ?>
                                    <?php foreach ($complaints as $complaint): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button class="action-btn btn-view" onclick="viewComplaint('<?= esc($complaint['subject']) ?>', '<?= esc($complaint['description']) ?>', '<?= $complaint['status'] ?>', '<?= date('M d, Y H:i', strtotime($complaint['created_at'])) ?>')">
    ...
    <script>
        function viewComplaint(subject, description, status, date) {
